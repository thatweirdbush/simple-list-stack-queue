/*****************************************
// Implement Queue from Linked List
******************************************/
#include <iostream>
...
bool isEmpty(Queue q) {
	return q.list.pHead == nullptr;
}

// Hàm thêm một phần tử vào Queue
...
// Thử nghiệm tất cả các hàm Queue đã cài đặt
int main() {
	Queue q;
	...
	cout << "Kiem tra Queue rong: " << (isEmpty(q) ? "true" : "false") << endl;

	cout << "Push 10 phan tu vao Queue:\n";
	Data data;
	for (int i = 0; i < 10; i++) {
		data.x = i;
		Push(q, data);
